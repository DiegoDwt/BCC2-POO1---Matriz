...
public class Ex4 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < num; i++) {
			...
			System.out.println("");
			System.out.println("Média do atleta = " + mediaAtleta[i]);
			System.out.println("-------------------------------------");
		}
		...
		System.out.println("Média do último lugar = " + ultimo);
		System.out.println("Média do campeão = " + campeao);
